-- Provider-neutral prompt construction shared by the Codex and Claude providers.
local M = {}
...
function M.base_instructions(opts, provider_opts)
  local user_override = provider_opts and provider_opts.base_instructions or nil
  local lines = {
    "You power a Neovim inline autocomplete feature.",
    "Each message is an independent completion request; ignore earlier requests in this conversation.",
